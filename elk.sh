...
echo -e "\e[36m Installing Kibana\e[0m"
yum install kibana -y

echo -e "\e[36m Enabling and starting Kibana\e[0m"
systemctl enable kibana
systemctl restart kibana

echo -e "\e[36m Installing logstash\e[0m"
...
echo -e "\e[36m Enabling and starting logstash\e[0m"
